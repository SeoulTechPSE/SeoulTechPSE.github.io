...
Note that the traction-free boundaries $\Gamma_N$ do not require explicit constraints in the variational formulation, since they are naturally included through the weak form of the problem
...
Next, we define discontinuous functions for permeability $\mu$ and current $J_z$, based on the `MeshTags` as in [Defining subdomains for different materials](12_3_Defining_Subdomains_for_Different_Materials)
