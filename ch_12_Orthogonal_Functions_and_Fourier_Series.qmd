...
![](figures/ch12_figure01_02.png "even and odd function"){fig-align="center" width="60%"}
...
def example_plot4():
    ...
    for m in range(mm):
        ax1.text(alpha_0m[m] -0.2, 0.1, r'$\alpha_{%d}$' % (m +1), 
            fontsize=12)
    ax1.legend()
...
def example_plot4__():
    ...
    for m in range(mm):
        ax1.text(alpha_0m[m] -0.2, 0.4, r'$\alpha_{%d}$' % (m +1), 
            fontsize=12)
    ax1.legend()
...
def example_plot4___():
    ...
    for m in range(mm):
        ax1.text(alpha_0m[m] -0.3, 0.05, r"$\alpha_{%d}$" % (m + 1), 
            fontsize=12)
    ax1.legend()
