...
def example_plot5(alpha, omega, t, x):
    ...
    plt.title(rf'$\alpha={alpha:2.1f}, \;\xi={omega:2.1f}$')
...
$$ \mathrm{erfc}(\eta)=\frac{2}{\sqrt{\pi}} \int_\eta^\infty e^{-t^2}\,dt$$
...
## $~$The Convection Term $u_x$ in the Diffusion Problems {#sec-x1-17}
